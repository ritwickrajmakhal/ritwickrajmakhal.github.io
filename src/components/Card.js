...
export default function Card(props) {
    ...
    return (
        <div
            ...
            className={props.darkMode ? "card m-2 p-2 shadow-lg rounded-4 text-light cursor-pointer" : "card m-2 p-1 shadow-lg rounded-4 cursor-pointer"}
            ...
            <div className="card-footer">
                ...
                <p
                    ...
                    role={'button'} onClick={() => props.setModalContent(props.modalContent)}
